...
## 13. Runtime-локализация

Сейчас BuildWorks просит Valheim локализовать названия native-деталей, но собственные строки каталога, редактора, HUD, ошибок, параметров инструментов, категорий и метаданных adaptive pieces встроены по-русски. В 0.19.33 нет runtime-переключателя языка, английского каталога, fallback-слоя и автоматических locale-тестов.

**Статус:** не реализовано. English-first runtime-локализация с полным русским каталогом добавлена как обязательная основа в [ROADMAP](ROADMAP_RU.md). Английская GitHub-документация не означает, что текущий интерфейс игры уже переведён на английский.
